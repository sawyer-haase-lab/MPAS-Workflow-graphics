...
dbConf['firstCycleDTime'] = dt.datetime(2018,4,17,0,0,0)
dbConf['lastCycleDTime'] = dt.datetime(2018,4,21,0,0,0)
...
dbConf['fcTDeltaFirst'] = dt.timedelta(days=0,hours=0)
...
dbConf['cntrlExpName'] = 'GETKF-ClrSky'
...
#experiments['RefL40-JB'] = \
#  'jban_3denvar_OIE120km_WarmStart_AMSU' + \
#  deterministicVerifyDir

experiments['GETKF-ClrSky'] = \
  'taosun_3dhybrid-60-60-iter_O30kmI60km_GETKF80_BC_ClrSky' + \
  deterministicVerifyDir

experiments['GETKF-AllSky'] = \
  'taosun_3dhybrid-60-60-iter_O30kmI60km_GETKF80_BC_AllSky' + \
  deterministicVerifyDir

experiments['GETKF-AllSky-Cloud'] = \
  'taosun_3dhybrid-60-60-iter_O30kmI60km_GETKF80_BC_AllSky_ML' + \
  deterministicVerifyDir
