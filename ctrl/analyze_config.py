...
dbConf['firstCycleDTime'] = dt.datetime(2023,2,18,18,0,0) ##edited
dbConf['lastCycleDTime'] = dt.datetime(2023,2,20,00,0,0) ##edited
...
dbConf['fcTimeInc'] = dt.timedelta(hours=12) ##edited
...
VerificationSpace = 'model' ##edited
...
user = 'ersawyer' ##edited
dbConf['expDirectory'] = os.getenv('EXP_DIR','/glade/derecho/scratch/'+user+'/sio-cw3e')
